define([
    ...
    "dojo/html",
    "dojo/_base/event",
    "mxdrag/lib/jquery-1.11.2",
    "dojo/text!mxdrag/widget/template/mxdrag.html"
    ...
    return declare("mxdrag.widget.mxdrag", [ _WidgetBase, _TemplatedMixin ], {
